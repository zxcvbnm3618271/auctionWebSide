...
public enum AuctionStateEnum {
	...
	AUCTION_ADD_SUCCESS("addsuccess","添加成功"),
	AUCTION_ADD_FAIL("addfail","添加失败"),
	AUCTION_UPDATE_SUCCESS("updatesuccess","更新成功"),
	AUCTION_UPDATE_FAIL("updatefail","更新失败"),
	AUCTION_DELETE_SUCCESS("deletesuccess","删除成功"),
